        ...
        <div id="topbar" className="d-flex align-items-center fixed-top">
            <div className="container d-flex justify-content-between">
                <div className="contact-info d-flex align-items-center">
                    <FaEnvelope className='contact-icon'/> <a href="mailto:mayankjhanwar29@gmail.com">uhi@gmail.com</a>
                    <FaPhoneAlt className='contact-icon'/> <a href="tel:+91 9511354539">+91 9511354539</a> 
                </div>
